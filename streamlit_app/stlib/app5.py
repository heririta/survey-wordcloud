...
def run():
    ...
    st.info('2. Apa yang mendasari pilihan Anda pada pertanyaan diatas ?')
    generate_wordcloudSurvey(
        column_name='2. Apa yang mendasari pilihan Anda pada pertanyaan diatas ?')
    # plot_word_count(objectdata_frame,
    #                 '2. Apa yang mendasari pilihan Anda pada pertanyaan diatas ?')

    # summary = objectdata_frame['2. Apa yang mendasari pilihan Anda pada pertanyaan diatas ?'].describe(
    # )
    # st.info(summary)
    ...
    # st.info('summary')
    # st.text('Teks tersebut membahas pentingnya pembangunan kantor baru yang ramah lingkungan dan berkonsep smart building di Indonesia. Pembangunan ini diharapkan dapat mengurangi polusi, mencerminkan perkembangan teknologi yang lebih maju, serta mendukung tujuan pembangunan berkelanjutan. Green building menjadi kunci untuk masa depan yang sehat dengan menggabungkan keberlanjutan lingkungan, kesejahteraan manusia, dan efisiensi ekonomi dalam bangunan. Kantor baru ini diharapkan menjadi simbol konsep smart dan green city, serta memberikan kenyamanan bagi pegawai dan masyarakat. Pembangunan ini juga menekankan pentingnya menjaga kelestarian lingkungan, dengan berfokus pada pemanfaatan sumber daya yang lebih efisien dan ramah lingkungan. Konsep green building diharapkan menginspirasi pembangunan lebih lanjut di Indonesia untuk mengutamakan kelestarian alam. Selain itu, pembangunan ini juga diarahkan untuk mendukung program pemerintah, mengatasi masalah polusi udara, dan menciptakan lingkungan yang lebih bersahabat bagi penduduk. Tujuan akhirnya adalah menciptakan gedung kantor yang memiliki desain timeless, elegan, dan modern dengan teknologi terkini, tetapi tetap memperhatikan dampak lingkungan dan keberlanjutan hidup.')
