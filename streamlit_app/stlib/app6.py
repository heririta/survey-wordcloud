...
def run():
    ...
    st.info('3. Berikan satu kata yang menggambarkan kantor LPS di IKN nantinya..')
    generate_wordcloudSurvey(
        column_name='3. Berikan satu kata yang menggambarkan kantor LPS di IKN nantinya..')
    plot_word_count(
        objectdata_frame, '3. Berikan satu kata yang menggambarkan kantor LPS di IKN nantinya..')
